...
const Footer = () => {
  return (
    <footer className="bg-slate-100 text-slate-700 mt-16 border-t border-slate-200">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600">support@shopease.com</p>

          <div className="flex gap-4 mt-4 text-slate-500 text-lg">
            <FaFacebookF className="hover:text-indigo-500 transition cursor-pointer" />
            ...
            <FaTiktok className="hover:text-slate-700 transition cursor-pointer" />
          </div>
        </div>

        {/* Menu */}
        <div>
          <h3 className="font-semibold text-slate-800 mb-3">Menu</h3>
        ...
        {/* Sitemap */}
        <div>
          <h3 className="font-semibold text-slate-800 mb-3">Sitemap</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-indigo-600 transition">Login</a></li>
            <li><a href="#" className="hover:text-indigo-600 transition">Register</a></li>
        ...
        {/* Useful Links */}
        <div>
          <h3 className="font-semibold text-slate-800 mb-3">Useful Links</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-indigo-600 transition">Info Centre</a></li>
            <li><a href="#" className="hover:text-indigo-600 transition">Dosing Chart</a></li>
            <li><a href="#" className="hover:text-indigo-600 transition">Expert Advice</a></li>
            <li><a href="#" className="hover:text-indigo-600 transition">Video Library</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-slate-200 text-center py-4 text-xs text-slate-500">
        © {new Date().getFullYear()} ShopEase. Website by{" "}
        <a href="#" className="hover:text-indigo-600 underline transition">
          Karthika
        </a>
      </div>
